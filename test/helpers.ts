...
export function readyManifest(type: "free" | "paid-app" | "non-consumables" | "subscriptions" = "free"): ShipLayerManifest {
  ...
  manifest.app.primaryCategory = "Productivity"; manifest.contacts = { supportEmail: "support@example.com", supportUrl: "https://example.com/support", privacyUrl: "https://example.com/privacy", copyright: "2026 Example" };
