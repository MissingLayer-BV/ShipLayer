...
export const IGNORED_DIRECTORIES = new Set([".git", ".claude", "node_modules", "Pods", "Carthage", "DerivedData", "build", ".build", "dist", ".swiftpm", "vendor", "release", "shiplayer-release", ".shiplayer-staging", ".next", ".turbo", "coverage", ".cache", ".tools", ".wrangler", ".wrangler-dry-run"]);
