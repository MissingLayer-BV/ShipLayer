...
function emptyDiscovery(): RemoteDiscovery { return { appInfos: [], appInfoLocalizations: [], versions: [], versionLocalizations: [], builds: [], selectedBuilds: [], reviewDetails: [], screenshotSets: [], screenshots: [], screenshotGroups: [], categories: [], primaryCategories: [], secondaryCategories: [], inAppPurchases: [], subscriptionGroups: [], subscriptions: [] }; }
