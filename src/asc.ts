...
export interface RemoteDiscovery { appId?: string; app?: unknown; appInfos: unknown[]; appInfoLocalizations: unknown[]; versions: unknown[]; versionLocalizations: unknown[]; builds: unknown[]; reviewDetails: unknown[]; screenshotSets: unknown[]; screenshots: unknown[]; inAppPurchases: unknown[]; subscriptionGroups: unknown[] }
...
export class AppStoreConnectClient {
  ...
  async discover(bundleId: string, selection: DiscoverySelection = {}): Promise<RemoteDiscovery> {
    ...
    return { appId, app: appResponse.data?.[0], appInfos, appInfoLocalizations, versions, versionLocalizations, builds, reviewDetails, screenshotSets, screenshots, inAppPurchases: dataOf(inAppPurchases), subscriptionGroups: dataOf(subscriptionGroups) };
  }
}
...
function emptyDiscovery(): RemoteDiscovery { return { appInfos: [], appInfoLocalizations: [], versions: [], versionLocalizations: [], builds: [], reviewDetails: [], screenshotSets: [], screenshots: [], inAppPurchases: [], subscriptionGroups: [] }; }
